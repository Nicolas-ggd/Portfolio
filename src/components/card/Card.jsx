...
export const Card = () => {
  ...
  return (
    <div className="w-full px-5 sm:px-10 h-full transition duration-300 py-10 bg-gray-200 dark:bg-black">
      <div className="flex flex-col mx-auto max-w-screen-xl px-3">
        <div data-aos="fade-right" className="px-2 py-6">
          <h1 className="text-5xl dark:text-white text-dark">Projects</h1>
          <p className="py-2 text-xl dark:text-gray-500 py-4">
